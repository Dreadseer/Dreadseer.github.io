// Static links data — imported by Links.jsx for the resource cards grid
// TODO: Add real card images to public/assets/ before submission

export const links = [
  {
    title: 'MDN Web Docs',
    description:
      'The go-to reference for HTML, CSS, and JavaScript. ' +
  ...
  },
  {
    ...
    description:
      'Official React docs with guides, API references, and interactive ' +
  ...
  },
  {
    title: 'Supabase Docs',
    description:
      'Documentation for Supabase covering database setup, authentication, ' +
  ...
  },
  {
    title: 'LeetCode',
    description:
      'Practice platform for coding challenges and technical interview ' +
  ...
  },
  {
    title: 'GitHub',
    description:
      'Version control and collaboration platform — home to all CodeBoxx ' +
  ...
  },
  {
    ...
    description:
      'Official docs for building React Native apps with Expo, including ' +
